...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|Mod (Val)| +1 (12) | -1 (8) | +1 (13) | +0 (10) | +3 (16) | +2 (15) |
|**Save**| +1 | -1 | +1 | +0 | +5 | +4 |
...
| ---- | ---- | ---- | ---- |
| light crossbow | +1 | 1d8-1 (pierce) | range 80/320, loading, 20/20 bolts|
| mace | +3 | 1d6+1 (bludge) ||
...
| 0 | guidance | action, touch, VS, Conc 1min max |  target can roll a d4 and add the number rolled to one ability check of its choice. It can roll the die before or after making the ability check |
| 1 | bless | action, 30ft, VSM, Conc 1min max | up to three creatures of your choice within range. Whenever a target makes an attack roll or a saving throw before the spell ends, the target can roll a d4 and add the number rolled to the attack roll or saving throw. |
| 1 | cure wounds | action, touch, VS, instant | heal 1d8+5 hp |
...
| 1 | healing word | bonus, 60ft, V, instant | A creature of your choice that you can see within range regains 1d4+5 hp |
